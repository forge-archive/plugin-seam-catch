...
class CatchPlugin implements org.jboss.forge.shell.plugins.Plugin {
     ...
     */
    @Command(value = "setup", help = "Install Seam Catch into the current project.")
     ...
     * @throws java.io.FileNotFoundException If the source file being created is not able to be saved
     */
    ...
    public void newExceptionHandlerContainer(
            @Option(required = true, name = "named",
                    description = "The name of the containing class to create") String className,
            @Option(required = false, name = "package", type = PromptType.JAVA_PACKAGE,
                    description = "Containing package name") final String packageName) throws FileNotFoundException {
        ...
        if ((packageName != null) && !"".equals(packageName))
            ...
            containerPackage = prompt.promptCommon("In which package would you like to create this Exception Handler container:",
